...
class SmaCross(bt.SignalStrategy):
    def __init__(self, store):
        ...
        self.bbM5 = btind.BollingerBands(self.datas[0])
        self.bbM15 = btind.BollingerBands(self.datas[1])
        self.smaM5 = btind.MovingAverageSimple(self.datas[0])
        self.smaM15 = btind.MovingAverageSimple(self.datas[1])

        self.lr1 = LinearRegression(self.datas[0], len=21)
        self.lr2 = LinearRegression(self.datas[1], len=21)

        self.ohlc = OHLC(self.datas[1], len=21)
        ...
        chartM15 = MTraderChart(self.datas[1], realtime=True)
        addChart(chartM15, self.bbM15, self.smaM15, self.lr2, self.ohlc)
